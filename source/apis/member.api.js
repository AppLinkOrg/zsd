...
export class MemberApi{
    ...
    login(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/login',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    renyuaninfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/renyuaninfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    yuangong(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/yuangong',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
